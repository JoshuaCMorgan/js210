...
to strings. In this exercise, you're going to extend that function by adding the
...
as String() and Number.prototype.toString(). You may, however, use integerToString() 
