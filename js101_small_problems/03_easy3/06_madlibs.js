...
let request = function(element) {
 return readlineSync.question(`Enter a ${element}: `);
};

const noun = request('noun');
const verb = request('verb');
const adjective = request('adjective');
const adverb = request('adverb');
