/*
In this exercise, you will implement your own versions of the Array.prototype.
shift and Array.prototype.unshift methods. These methods manipulate the contents
of an array starting from the first index.
...
function shift(array) {
  ...
  copyArray.forEach(element => array.push(element));
  return firstElement;
}
...
function unshift(array, ...args) {
  ...
  args.forEach(element => copyArray.push(element));
