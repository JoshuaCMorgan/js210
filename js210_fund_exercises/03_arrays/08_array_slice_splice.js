/*
n this exercise, you will implement your own versions of the Array.prototype.slice and Array.prototype.splice methods according to the following specifications.
...
The splice function changes the contents of an array by deleting existing elements and/or adding new elements. The function takes the following arguments:
...
the start index. If any optional element arguments are provided, splice insert
...
The values of start and deleteCount will always be integers greater than or equal
to 0.
