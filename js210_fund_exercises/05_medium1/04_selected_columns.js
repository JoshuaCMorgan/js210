...
/*
length is being reassigned in the inner for loop, making changes to 
the outer for loop.
The culprit is 'var' keyword which is scoped at the function level.
'let' keyword is scoped at the block level and would fix this. 
*/